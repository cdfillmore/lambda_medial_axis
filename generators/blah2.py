...
def elip0():
    ...
    #0 int 1 a
    if (deg >= (-11 - 15)%360) & (deg < -11%360):
        z = 0 - 0.5*rand_const + rand_const*np.random.rand(1,1)[0][0] + ((deg - 334)%360)*lift
    elif not((deg < -11%360) & (deg > (-11 + 15)%360)):
        z = 0 - 0.5*rand_const + rand_const*np.random.rand(1,1)[0][0] + ((349 + 15 - deg)%360)*lift
    #0 int 1 b
    elif (deg > (255 - 15)%360) & (deg < 255):
        z = 0 - 0.5*rand_const + rand_const*np.random.rand(1,1)[0][0] + (deg - 240)*lift
    elif (deg >= 255) & (deg < (255 + 15)%360):
        z = 0 - 0.5*rand_const + rand_const*np.random.rand(1,1)[0][0] + (255 + 15 - deg)*lift
    #normal
    else:
...
def elip1():
    ...
    x0 = 10*np.sin(np.pi*2/3)
    y0 = 10*np.cos(np.pi*2/3)
    ...
    #1 int 2 a
    if (deg > (133 - 15)%360) & (deg < 133):
        z = 0 - 0.5*rand_const + rand_const*np.random.rand(1,1)[0][0] + (deg - 118)*lift
    elif (deg >= 133) & (deg < (133 + 15)%360):
        z = 0 - 0.5*rand_const + rand_const*np.random.rand(1,1)[0][0] + (133 + 15 - deg)*lift
    #1 int 2 b
    elif (deg > (228 - 15)%360) & (deg < 228):
        z = 0 - 0.5*rand_const + rand_const*np.random.rand(1,1)[0][0] + (deg - 213)*lift
    elif (deg >= 228) & (deg < (228 + 15)%360):
        z = 0 - 0.5*rand_const + rand_const*np.random.rand(1,1)[0][0] + (228 + 15 - deg)*lift
    #normal
    else:
        z = 0 - 0.5*rand_const + rand_const*np.random.rand(1,1)[0][0]
...
def elip2():
    ...
    x0 = 10*np.sin(np.pi*4/3)
    y0 = 10*np.cos(np.pi*4/3)
    ...
    #2 int 0 a
    if not((deg < (11 - 15)%360) & (deg > 11)):
        z = 0 - 0.5*rand_const + rand_const*np.random.rand(1,1)[0][0] + ((deg - 356)%360)*lift
    elif (deg >= 11) & (deg < (11 + 15)%360):
        z = 0 - 0.5*rand_const + rand_const*np.random.rand(1,1)[0][0] + (11 + 15 - deg)*lift
    #2 int 0 b
    elif (deg > (108 - 15)%360) & (deg < 108):
        z = 0 - 0.5*rand_const + rand_const*np.random.rand(1,1)[0][0] + (deg - 93)*lift
    elif (deg >= 108) & (deg < (108 + 15)%360):
        z = 0 - 0.5*rand_const + rand_const*np.random.rand(1,1)[0][0] + (108 + 15 - deg)*lift
    #normal
    else:
        z = 0 - 0.5*rand_const + rand_const*np.random.rand(1,1)[0][0]
...
for N in [100,300,500,1000,3000,5000,10000]:
    ...
    with open('/home/cfillmor/topology/medial/pt_sets/boro_plane_'+str(N) + '.json', 'w') as out:
